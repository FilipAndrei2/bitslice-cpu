...
HD_PWD='C:/Users/student/temp/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_top_sistem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_top_sistem.tcl
